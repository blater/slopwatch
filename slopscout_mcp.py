...
from slopscout import AnalysisResult, FileMetrics, analyze_java
from slopscout import build_report_document, project_relative_path
...
def create_server() -> Any:
  ...
  try:
    ...
    raise RuntimeError(
        "MCP support is not installed; install slopscout with its mcp extra"
    ) from error

  server = MCPServer(
      name="slopscout",
      title="slopscout Java design-debt scorer",
      description=(
